...
public interface ErrorCodeConstants {
    ...
    ErrorCode PROCESS_INSTANCE_START_USER_SELECT_ASSIGNEE_NOT_ALLOWED = new ErrorCode(1_009_004_009,
            "任务({})的候选人({})不在可选审批人范围内");
    ErrorCode PROCESS_INSTANCE_START_USER_SELECT_ASSIGNEE_COUNT_INVALID = new ErrorCode(1_009_004_010,
            "任务({})只能选择一名审批人");
