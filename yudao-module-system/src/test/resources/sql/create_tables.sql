...
CREATE TABLE IF NOT EXISTS "system_notice" (
	...
	"publish_target" varchar(255) DEFAULT '全体后台用户' COMMENT '发布对象',
	"pinned" bit NOT NULL DEFAULT FALSE COMMENT '是否置顶',
	"attachment_file_ids" varchar(512) DEFAULT NULL COMMENT '附件文件编号列表，逗号分隔',
...
CREATE TABLE IF NOT EXISTS "system_kod_sso_user_bind" (
   ...
   "kod_access_token" varchar(2048) DEFAULT NULL,
   "creator" varchar(64) DEFAULT '',
   "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
   "updater" varchar(64) DEFAULT '',
   "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_kod_dept_sync" (
   "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "kod_group_id" varchar(64) NOT NULL,
   "local_dept_id" bigint DEFAULT NULL,
   "kod_source_id" bigint DEFAULT NULL,
   "kod_parent_group_id" varchar(64) DEFAULT NULL,
